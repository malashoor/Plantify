...
import { View, StyleSheet, ScrollView, Image, Text, TouchableOpacity, useColorScheme, ActivityIndicator } from 'react-native';
        ...
        <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
            <ScrollView style={styles.content}>
                <SnapshotGenerator ref={snapshotRef}>
                    ...
                    <Text style={[styles.journalContent, { color: theme.colors.text }]}>{journal.content}</Text>
                    ...
                    {journal.comments && journal.comments.length > 0 && (
                        <View style={styles.comments}>
                            ...
                            {journal.comments.map((comment, index) => (
                                <View key={index} style={[styles.comment, { backgroundColor: theme.colors.surface }]}>
