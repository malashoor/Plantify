...
import { View, StyleSheet, ScrollView, RefreshControl, Text, TouchableOpacity, useColorScheme, Alert } from 'react-native';
...
const ReminderCard = ({ reminder, onComplete, onToggleActive, onDelete }: any) => {
  ...
  return (
    <View style={[styles.reminderCard, { backgroundColor: theme.colors.surface, borderColor: theme.colors.border }]}>
      <View style={styles.reminderHeader}>
        ...
        <TouchableOpacity
          ...
          style={[styles.activeToggle, { backgroundColor: reminder.isActive ? theme.colors.success : theme.colors.textSecondary }]}
        >
...
export default function RemindersScreen() {
    ...
    const { reminders, isLoading, updateReminder, deleteReminder, getTodaysReminders, markComplete, toggleActive } = useReminders();
