...
const ActionButtons = ({
  ...
  <View style={styles.buttonContainer}>
    <TouchableOpacity style={styles.primaryButton} onPress={onSpeak}>
...
export default function AnalyzeScreen() {
  ...
  if (loading) {
    return <LoadingState message={t('analyze.loading')} />;
  }

  if (error) {
    return <ErrorState message={error} onRetry={handleReset} />;
  }
      ...
      <View style={styles.content}>
        ...
        {result && (
          <View style={styles.resultContainer}>
            ...
            <ActionButtons onSpeak={speakResult} onReset={handleReset} t={t} />
          </View>
        )}
      </View>
    </ScrollView>
