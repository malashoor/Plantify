...
export const ReminderCard: React.FC<ReminderCardProps> = ({
    ...
    const getTypeIcon = (type: Reminder['type']) => {
        switch (type) {
            ...
            default:
                return { name: 'notifications' as keyof typeof Ionicons.glyphMap, color: theme.colors.grey3 };
        }
    };
    ...
    return (
        <Card style={[styles.card, { backgroundColor: theme.colors.background, borderColor: theme.colors.border }]}>
