...
export const useSensorHub = ({ systemId, plantId, refreshInterval = 60000 }: UseSensorHubProps) => {
  ...
  const checkForAlerts = useCallback(async () => {
    ...
    for (const threshold of thresholds) {
      ...
      if (
        threshold.alert_on_above &&
        threshold.max_value !== undefined &&
        latestValue > threshold.max_value
      ) {
      ...
      if (
        threshold.alert_on_below &&
        threshold.min_value !== undefined &&
        latestValue < threshold.min_value
      ) {
        const alert: SensorAlert = {
  ...
  const data: SensorData = {
    ...
    status:
      isLoadingReadings || isLoadingThresholds
        ? 'loading'
        : readingsError || thresholdsError
          ? 'error'
          : 'success',
  };
  ...
  function mapDbFieldToSensorType(dbRecord: any): SensorType {
    ...
    if (dbRecord.water_temperature !== undefined && dbRecord.water_temperature !== null)
      return 'temperature';
    if (dbRecord.water_level !== undefined && dbRecord.water_level !== null) return 'water_level';
    if (dbRecord.dissolved_oxygen !== undefined && dbRecord.dissolved_oxygen !== null)
  ...
  function mapDbFieldToValue(dbRecord: any): number {
    ...
    if (dbRecord.water_temperature !== undefined && dbRecord.water_temperature !== null)
      return dbRecord.water_temperature;
    if (dbRecord.water_level !== undefined && dbRecord.water_level !== null)
      return dbRecord.water_level;
    if (dbRecord.dissolved_oxygen !== undefined && dbRecord.dissolved_oxygen !== null)
      return dbRecord.dissolved_oxygen;
    if (dbRecord.light_level !== undefined && dbRecord.light_level !== null)
      return dbRecord.light_level;
