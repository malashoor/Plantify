...
export const useSeeds = () => {
    ...
    const createSeed = useCallback(async (formData: SeedFormData): Promise<Seed | null> => {
        try {
            setLoading(true);
            setError(null);
    ...
    const updateSeedStage = useCallback(async (
        seedId: string,
    ...
    const deleteSeed = useCallback(async (seedId: string): Promise<boolean> => {
        try {
            setLoading(true);
            setError(null);
