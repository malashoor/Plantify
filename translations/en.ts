export default {
  ...
  nutrient: {
    ...
    voice: {
      ...
      calculation_complete:
        'Recipe calculation complete. {{nutrientCount}} nutrients calculated. Estimated time: {{time}} minutes.',
    },
    ...
    accessibility: {
      ...
      results_summary:
        'Recipe contains {{nutrients}} nutrients. Estimated mixing time: {{time}} minutes',
      ...
      calculation_complete:
        'Recipe calculation complete. {{nutrients}} nutrients calculated. Estimated mixing time: {{time}} minutes',
  ...
  lighting: {
    ...
    recommendations: {
      ...
      ppfd_low_desc:
        'Current PPFD ({{current}}) is below optimal ({{optimal}}). Move light closer.',
      ppfd_high_title: 'High Light Intensity',
      ppfd_high_desc:
        'Current PPFD ({{current}}) is above optimal ({{optimal}}). Move light further.',
      dli_low_title: 'Insufficient Daily Light',
      dli_low_desc:
        'Current DLI ({{current}}) is below optimal ({{optimal}}). Increase photoperiod.',
    ...
    voice: {
      ...
      calculation_complete:
        'Lighting calculation complete. PPFD: {{ppfd}}, DLI: {{dli}}, Monthly cost: {{cost}} {{currency}}',
    },
    ...
    accessibility: {
      ...
      led_option:
        '{{name}} LED light, {{wattage}} watts, PPFD {{ppfd}} micromoles per square meter per second, covers {{coverage}} square meters',
      ...
      results_section: 'Calculation results section',
      results_summary:
        'Daily light integral is {{dli}} moles per square meter per day, power consumption is {{power}} kilowatt hours per day, estimated cost is ${{cost}} per day',
      ...
      stage_selected: '{{stage}} selected as growth stage',
      led_selected:
        '{{name}} LED selected with {{ppfd}} PPFD and {{coverage}} square meter coverage',
      ...
      calculation_complete:
        'Calculation complete. Daily light integral: {{dli}}, Power usage: {{power}} kilowatt hours, Cost: ${{cost}} per day',
  ...
  advisor: {
    ...
    diagnosis: {
      yellowingPH:
        'Yellowing leaves are often caused by pH imbalance. Your current pH is outside the optimal range, preventing proper nutrient uptake.',
      yellowingNutrients:
        'The yellowing appears to be nutrient-related. Your EC levels suggest nutrient deficiency.',
      yellowingGeneral:
        'Yellowing can have several causes. Let me analyze your current conditions to provide specific guidance.',
      slowGrowthLight:
        'Slow growth may be due to insufficient lighting. Consider increasing PPFD or extending photoperiod.',
      slowGrowthNutrients:
        'Growth issues often relate to nutrient imbalances. Your current EC and pH levels need adjustment.',
    },
    ...
    voice: {
      ...
      phAdjustmentNeeded:
        'Critical pH issue detected. Immediate adjustment required to prevent nutrient lockout.',
  ...
  ai: {
    ...
    emptyDescription:
      'I can help you with plant care, diagnose issues, and provide personalized recommendations.',
  ...
  settings: {
    ...
    location: {
      ...
      description:
        'Allow GreensAI to use your location to provide climate-specific plant care recommendations.',
      permission_needed: 'Location Permission Required',
      permission_message:
        'GreensAI needs location access to provide personalized plant care advice.',
